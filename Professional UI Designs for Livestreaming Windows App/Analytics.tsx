    ...
    <AppSidebar>
      ...
      <div className="flex items-center gap-3 px-4 shrink-0" style={{ height: 46, background: "#1A2035", borderBottom: "1px solid #2A3350" }}>
        ...
        {["5m","15m","1h","3h","6h","12h"].map(r => (
          <button key={r} onClick={() => setRange(r)} className="px-2 py-0.5 rounded text-xs transition-all" style={{ background: range === r ? "#22D3EE18" : "transparent", border: range === r ? "1px solid #22D3EE40" : "1px solid transparent", color: range === r ? "#22D3EE" : "#50506A", fontFamily: "'DM Sans', sans-serif", fontSize: 11 }}>{r}</button>
        ))}
        <button className="flex items-center gap-1.5 px-2.5 py-1 rounded" style={{ background: "#1A1A24", border: "1px solid #303D5A" }}>
          <Download size={12} style={{ color: "#8892A4" }} />
          <span style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 11, color: "#8892A4" }}>Export</span>
        </button>
      </div>

      <div className="flex-1 overflow-y-auto px-4 py-3" style={{ background: "#161B2E" }}>
        {/* KPI cards */}
        ...
        {/* Main viewer chart */}
        <div className="rounded mb-4" style={{ background: "#1E2640", border: "1px solid #2A3350" }}>
          ...
          <div className="px-2 pb-3 pt-1">
            <ResponsiveContainer width="100%" height={140}>
              <AreaChart data={viewerData} margin={{ top: 4, right: 4, left: -20, bottom: 0 }}>
                ...
                <Tooltip contentStyle={{ background: "#1A1A24", border: "1px solid #303D5A", borderRadius: 4, fontSize: 11, fontFamily: "'DM Sans', sans-serif", color: "#F8F8FF" }} />
        ...
        <div className="grid grid-cols-3 gap-3 mb-4">
          {/* Stream health */}
          <div className="col-span-2 rounded" style={{ background: "#1E2640", border: "1px solid #2A3350" }}>
            ...
            <div className="px-3 pb-3 pt-1">
              <ResponsiveContainer width="100%" height={100}>
                <LineChart data={HEALTH_DATA} margin={{ top: 4, right: 4, left: -20, bottom: 0 }}>
                  ...
                  <YAxis hide />
                  <Tooltip contentStyle={{ background: "#1A1A24", border: "1px solid #303D5A", borderRadius: 4, fontSize: 10, fontFamily: "'DM Sans', sans-serif", color: "#F8F8FF" }} />
          ...
          {/* Audience breakdown */}
          <div className="rounded" style={{ background: "#1E2640", border: "1px solid #2A3350" }}>
            ...
            <div className="px-3 py-2">
              ...
              <div className="mt-2 pt-2" style={{ borderTop: "1px solid #2A3350" }}>
